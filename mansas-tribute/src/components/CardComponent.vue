...
.card {
  ...
  &.selectable {
    cursor: pointer;
    &:hover { transform: translateY(-5px); box-shadow: 0 8px 18px rgba(0,0,0,0.5); }
  }

  &.selected {
    transform: translateY(-10px);
    box-shadow: 0 10px 24px rgba(201, 168, 76, 0.5);
