...
const strings = {
  en: {
    ...
    remainingDiceLabel: 'Dice:',
    diceSumOverTricks: (sum, tricks) => `total: ${sum} / ${tricks}`,
  ...
  he: {
    ...
    remainingDiceLabel: 'קוביות:',
    diceSumOverTricks: (sum, tricks) => `סה"כ: ${sum} / ${tricks}`,
