    ...
    <div class="modal">
      ...
      <template v-if="lang === 'en'">
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>Exactly 1 Tree played:</strong> that Tree wins, regardless of suit.</li>
            <li><strong>2 or more Trees played:</strong> all Trees are worth 0 — highest on-suit non-Tree wins.</li>
      ...
      <template v-else>
        ...
        <section>
          ...
          <p>לפני תחילת המשחק, כל שחקן בוחר <strong>קלף אחד מידו</strong> כהימור שלו. ההימור גלוי לכל ומייצג את המטרה שהשחקן שואף אליה.</p>
        </section>

        <section>
          <h3>שחקנ טריק</h3>
          <p>שחקן הפתיחה מניח כל קלף מידו <strong>או את קלף ההימור שלו</strong>. בכיוון השעון, כל שחקן חייב <strong>לעקוב אחרי החלפה</strong> (לשחק קלף באותו צבע) אם ביכולתו. אם אינו יכול, הוא רשאי לשחק כל קלף.</p>
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>2 עצים או יותר:</strong> כל העצים שווים 0 — הקלף הגבוה ביותר באותה חלפה שאינו עץ מנצח.</li>
...
li.indent { list-style: none; padding-left: 12px; color: rgba(255,255,255,0.7); }
</style>
